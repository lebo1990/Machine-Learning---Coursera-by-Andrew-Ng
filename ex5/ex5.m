...
%   error_test(i) = linearRegCostFunction(X_poly_test, ytest, theta, lambda); 
end

figure();
plot(lambda_vec, error_test);
xlabel('lambda');
ylabel('Test Error');

% error_test = linearRegCostFunction(X_poly_test, ytest, theta, lambda);
fprintf('Test error is %f when lambda = %d.\n', error_test(9), lambda_vec(9));
